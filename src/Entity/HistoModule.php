...
use App\Repository\HistoModuleRepository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: HistoModuleRepository::class)]
class HistoModule
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\OneToMany(mappedBy: 'module', targetEntity: HistoHistorique::class)]
    ...
    public function addHistoHistorique(HistoHistorique $histoHistorique): self
    {
        if (!$this->histoHistoriques->contains($histoHistorique)) {
            ...
            $histoHistorique->setModule($this);
        }
    ...
    public function removeHistoHistorique(HistoHistorique $histoHistorique): self
    {
        if ($this->histoHistoriques->removeElement($histoHistorique)) {
            ...
            if ($histoHistorique->getModule() === $this) {
                $histoHistorique->setModule(null);
            }
        }
