...
use App\Repository\AchStatutBonRepository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: AchStatutBonRepository::class)]
class AchStatutBon
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\OneToMany(mappedBy: 'statutBon', targetEntity: AchBonCommande::class)]
    ...
    public function addAchBonCommande(AchBonCommande $achBonCommande): self
    {
        if (!$this->achBonCommandes->contains($achBonCommande)) {
            ...
            $achBonCommande->setStatutBon($this);
        }
    ...
    public function removeAchBonCommande(AchBonCommande $achBonCommande): self
    {
        if ($this->achBonCommandes->removeElement($achBonCommande)) {
            ...
            if ($achBonCommande->getStatutBon() === $this) {
                $achBonCommande->setStatutBon(null);
            }
        }
