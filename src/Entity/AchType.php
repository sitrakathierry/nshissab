...
use App\Repository\AchTypeRepository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: AchTypeRepository::class)]
class AchType
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\OneToMany(mappedBy: 'type', targetEntity: AchBonCommande::class)]
    ...
    public function removeAchBonCommande(AchBonCommande $achBonCommande): self
    {
        if ($this->achBonCommandes->removeElement($achBonCommande)) {
            ...
            if ($achBonCommande->getType() === $this) {
                $achBonCommande->setType(null);
            }
        }
