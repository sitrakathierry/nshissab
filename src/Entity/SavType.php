...
use App\Repository\SavTypeRepository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: SavTypeRepository::class)]
class SavType
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\OneToMany(mappedBy: 'type', targetEntity: SavAnnulation::class)]
    ...
    public function removeSavAnnulation(SavAnnulation $savAnnulation): self
    {
        if ($this->savAnnulations->removeElement($savAnnulation)) {
            ...
            if ($savAnnulation->getType() === $this) {
                $savAnnulation->setType(null);
            }
        }
