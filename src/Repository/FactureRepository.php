        ...
        foreach ($crdDetails as $crdDetail) {
            ...
            if($crdDetail->getMontant() > 0)
            {
                $elements[] = [
                    ...
                    "currentDate" => $crdDetail->getDate()->format("d/m/Y"),
                    "dateFacture" => $crdDetail->getDate()->format("d/m/Y"),
                    "dateDebut" => $crdDetail->getDate()->format("d/m/Y"),
                    "dateFin" => $crdDetail->getDate()->format("d/m/Y"),
                    "annee" => $crdDetail->getDate()->format("Y"),
                    "mois" => $crdDetail->getDate()->format("m"),
                    "numero" => $facture->getNumFact(),
                    "entrepot" => $entrepot,
